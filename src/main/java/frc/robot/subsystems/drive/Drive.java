...
import frc.robot.util.constants.General;
import frc.robot.util.constants.General.Mode;
...
public class Drive extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // Update gyro alert
    gyroDisconnectedAlert.set(!gyroInputs.connected && General.currentMode != Mode.SIM);
  }
